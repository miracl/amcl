...
/* Don't Modify from here... */
	...
	public const int BN_CURVE = 0;
	public const int BLS_CURVE = 1;
...
// BLS455 Curve
	public const int MODBITS = 455; // Number of bits in Modulus
	public const int MOD8 = 3; // Modulus mod 8
	public const int BASEBITS = 60;
	public const int AES_S = 128;
...
/* RSA/DH modulus length as multiple of BIGBITS */
	public const int FFLEN = 8;

/* Don't Modify from here... */
	public static readonly int NLEN = (1 + ((MODBITS - 1) / BASEBITS));
	public static readonly int DNLEN = 2 * NLEN;
	public static readonly long BMASK = (((long)1 << BASEBITS) - 1);
	public static readonly int MODBYTES = (1 + (MODBITS - 1) / 8);
...
/* Finite field support - for RSA, DH etc. */
	public static readonly int FF_BITS = (BIGBITS * FFLEN); // Finite Field Size in bits - must be 256.2^n
...
// BLS455 Curve
	...
	public static readonly long[] Modulus = new long[] {0xAA00001800002ABL,0xC589556B2AA956AL,0xB9994ACE86D1BA6L,0x3954FCB314B8B3DL,0xE3A5B1D56234BD9L,0x95B49203003F665L,0x57955572AA00E0FL,0x555559555L};
	public const long MConst = 0xB3EF8137F4017FDL;
...
// BLS455 Curve
	...
	public const int CURVE_PAIRING_TYPE = BLS_CURVE;
	public const int CURVE_A = 0;

	public static readonly long[] CURVE_Order = new long[] {0x7FFFFC00001L,0xA00000400001CL,0x25E000750001D10L,0xE0000F10004F000L,0x80000380002L,0x10L,0x0L,0x0L};
	public static readonly long[] CURVE_B = new long[] {0xAL,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L};
	public static readonly long[] CURVE_Cof = new long[] {0xA9557FFAABFFAABL,0xAAB15555B54AAB6L,0x555556AAL,0x0L,0x0L,0x0L,0x0L,0x0L};
	public static readonly long[] CURVE_Gx = new long[] {0x6D4C5DDFDFCEDD1L,0x35C6F43B3A034FBL,0x7F05B56A579C725L,0xB1F2B8ECE11B321L,0x9F342AB0CFE8392L,0xA5911EE32767994L,0x3005E40CC56ABEDL,0x18855F3BL};
	public static readonly long[] CURVE_Gy = new long[] {0x404FD79A6619B9BL,0x69D80A5D6FA0286L,0xEE722322D91A493L,0xB1EE58431C1E968L,0xCA9BC8953801F5FL,0xDFAFD40FE9E388EL,0x9F8985FC3DEB0D6L,0x19A8DB77EL};

	public static readonly long[] CURVE_Bnx = new long[] {0x20000080000800L,0x10000L,0x0L,0x0L,0x0L,0x0L,0x0L,0x0L};
	public static readonly long[] CURVE_Cru = new long[] {0x9202FFC00000AA9L,0xFA5190F4A3762AL,0x8B2B9BDD548FEC9L,0xD7B469DB33A586AL,0xC91731354CAFD99L,0xF5B48D02FFFE695L,0x57955572A900E0EL,0x555559555L};
	public static readonly long[] CURVE_Fra = new long[] {0x9CCFBDCA2EBF21L,0x572F54A73379964L,0x72819F887545498L,0x22BBC1CAD1F8534L,0xA82CD7D435944F0L,0x4594F818D030F7BL,0xEDCBE3ADC0016A7L,0x397EA4973L};
	public static readonly long[] CURVE_Frb = new long[] {0xA033043B5D1438AL,0x6E5A00C3F72FC06L,0x4717AB46118C70EL,0x16993AE842C0609L,0x3B78DA012CA06E9L,0x501F99EA300E6EAL,0x69C971C4E9FF768L,0x1BD6B4BE1L};
	public static readonly long[] CURVE_Pxa = new long[] {0x475F20F0C1F542L,0x65D6070F8567E10L,0xD780698BB33D776L,0x71F685ED1531721L,0x303D3FEC5B6A49CL,0x8DEF064FF553CEBL,0xC0E9A31B4C463L,0x2ECB12FA8L};
	public static readonly long[] CURVE_Pxb = new long[] {0x99086EE6749F03DL,0xE89A55A5AC5EF2EL,0x7B41AECD88EA016L,0x622450FE6163E06L,0x755066E1C8E296FL,0xA80F219487326E8L,0x66DBFBB0BEAEE59L,0xECFFCE0L};
	public static readonly long[] CURVE_Pya = new long[] {0x83235A4581A77F4L,0x9F0F367B7A7E10AL,0x8FA0C4A66D55B9DL,0xEF03F65E0D6EC4CL,0x9C7DC299C1A9EC2L,0x32453CA21CFA5ACL,0x6C3DCD5ABB9C544L,0x22471D90AL};
	public static readonly long[] CURVE_Pyb = new long[] {0xF413B6D9E1FDBA2L,0xA7E630913DA0356L,0xFBC913D9AC488E2L,0x72E7CF61B401585L,0x656D801B21C89EDL,0xF9E921EEE0558F9L,0x3D2B7B03CFC8698L,0x33503CA8L};
// not used
	public static readonly long[][] CURVE_W = new long[][] {new long[] {}, new long[] {}};
	public static readonly long[][][] CURVE_SB = new long[][][] {new long[][] {new long[] {}, new long[] {}}, new long[][] { new long[] {}, new long[] {} }};
	public static readonly long[][] CURVE_WB = new long[][] {new long[] {}, new long[] {}, new long[] {}, new long[] {}};
	public static readonly long[][][] CURVE_BB = new long[][][] {new long[][] {new long[] {}, new long[] {}, new long[] {}, new long[] {}}, new long[][] { new long[] {}, new long[] {}, new long[] {}, new long[] {} }, new long[][] { new long[] {}, new long[] {}, new long[] {}, new long[] {} }, new long[][] { new long[] {}, new long[] {}, new long[] {}, new long[] {} }};
