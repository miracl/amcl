...
public class AES
{
	...
	public const int CTR1 = 30;
	public const int CTR2 = 31;
	public const int CTR4 = 33;
	public const int CTR8 = 37;
	public const int CTR16 = 45;
...
/* Rotates 32-bit word left by 1, 2 or 3 byte  */
  ...
  //  if (x && y) 
	...
	private static void increment(sbyte[] f)
	{
		int i;
		for (i = 0;i < 16;i++)
		{
...
/* Initialise cipher */
	public virtual bool init(int m, int nk, sbyte[] key, sbyte[] iv)
	{ // Key=16 bytes
...
/*
	public static void Main(string[] args)
	{
		...
		for (i = 0;i < 16;i++)
		{
			Console.Write("{0:X2} ", block[i] & 0xff);
		}
		Console.WriteLine("");
