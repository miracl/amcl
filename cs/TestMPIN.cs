...
/* Trusted Authority set-up */
 ...
 /* Create Client Identity */
		...
		sbyte[] HCID = MPIN.HASH_ID(sha,CLIENT_ID); // Either Client or TA calculates Hash(ID) - you decide!

		Console.Write("Client ID Hash= ");
		printBinary(HCID);
...
/* This encoding makes Time permit look random - Elligator squared */
		...
		//pin = scan.Next();
		pin = int.Parse(Console.ReadLine());  // conversion error fixed
...
*/
		...
		if (FULL)
		{
			sbyte[] H = MPIN.HASH_ALL(sha,HCID,pxID,pxCID,SEC,Y,Z,T);
