...
var PAIR = function(ctx) {
  ...
  var PAIR = {
    ...
    ate: function(P1, Q1) {
      var fa, fb, f, x, n, n3, K, lv, lv2, Qx, Qy, A, NP, r, nb, bt, i;
    ...
    ate2: function(P1, Q1, R1, S1) {
      var fa, fb, f, x, n, n3, K, lv, lv2, Qx, Qy, Sx, Sy, A, B, NP, NR, r, nb, bt, i;
    ...
    fexp: function(m) {
      var fa, fb, f, x, r, lv, x0, x1, x2, x3, x4, x5, y0, y1, y2, y3;
