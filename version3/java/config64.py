...
# if pairing friendly. M or D type twist, and sign of the family parameter x
	...
	if x==6:
		...
		curve_selected=True
	if x==7:
		curveset("GOLDILOCKS","56","58","448","7","GENERALISED_MERSENNE","EDWARDS","NOT","NOT","NOT")   # change to 58
		curve_selected=True
	if x==8:
	...
	if x==18:
		...
		pfcurve_selected=True
	if x==19:
		curveset("BLS383","48","58","383","3","NOT_SPECIAL","WEIERSTRASS","BLS","D_TYPE","POSITIVEX")  # change to 58
		pfcurve_selected=True

	if x==20:
		curveset("BLS381","48","58","381","3","NOT_SPECIAL","WEIERSTRASS","BLS","M_TYPE","NEGATIVEX")  # change to 58
		pfcurve_selected=True
