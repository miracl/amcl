...
# pairing_friendly is BN, BLS or NOT (if not pairing friendly
	...
	if x==2:
		...
		curve_selected=True
	if x==3:
		curveset("256","NIST256","NIST256","32","13","29","56","256","7","NOT_SPECIAL","WEIERSTRASS","NOT")
		curve_selected=True
	if x==4:
		curveset("256","BRAINPOOL","BRAINPOOL","32","13","29","56","256","7","NOT_SPECIAL","WEIERSTRASS","NOT")
		curve_selected=True
	if x==5:
		curveset("256","ANSSI","ANSSI","32","13","29","56","256","7","NOT_SPECIAL","WEIERSTRASS","NOT")
		curve_selected=True

	if x==6:
		curveset("336","HIFIVE","HIFIVE","42","","29","60","336","5","PSEUDO_MERSENNE","EDWARDS","NOT")
		curve_selected=True
	if x==7:
		curveset("448","GOLDILOCKS","GOLDILOCKS","56","","29","60","448","7","GENERALISED_MERSENNE","EDWARDS","NOT")
		curve_selected=True
	if x==8:
		curveset("384","NIST384","NIST384","48","","28","56","384","7","NOT_SPECIAL","WEIERSTRASS","NOT")
		curve_selected=True
	if x==9:
		curveset("416","C41417","C41417","52","","29","60","414","7","PSEUDO_MERSENNE","EDWARDS","NOT")
		curve_selected=True
	if x==10:
		curveset("528","NIST521","NIST521","66","","28","60","521","7","PSEUDO_MERSENNE","WEIERSTRASS","NOT")
		curve_selected=True
	...
	if x==23:
		curveset("256","BN254","BN254","32","13","29","56","254","3","NOT_SPECIAL","WEIERSTRASS","BN")
		pfcurve_selected=True
	if x==24:
		curveset("256","BN254CX","BN254CX","32","13","29","56","254","3","NOT_SPECIAL","WEIERSTRASS","BN")
		pfcurve_selected=True
	if x==25:
		curveset("384","BLS383","BLS383","48","","28","56","383","3","NOT_SPECIAL","WEIERSTRASS","BLS")
		pfcurve_selected=True
