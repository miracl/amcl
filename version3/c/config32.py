...
# pairing_friendly is BN, BLS or NOT (if not pairing friendly
	...
	if x==12:
		...
		curve_selected=True
	if x==13:
		curveset("384","384PM","NUMS384W","32","29","254","3","PSEUDO_MERSENNE","WEIERSTRASS","NOT")
		curve_selected=True
	if x==14:
		curveset("384","384PM","NUMS384E","32","29","256","3","PSEUDO_MERSENNE","EDWARDS","NOT")
		curve_selected=True
	if x==15:
		curveset("512","512PM","NUMS512W","32","29","256","7","PSEUDO_MERSENNE","WEIERSTRASS","NOT")
		curve_selected=True
	if x==16:
		curveset("512","512PM","NUMS512E","32","29","256","7","PSEUDO_MERSENNE","EDWARDS","NOT")
		curve_selected=True
