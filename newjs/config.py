...
# pairing_friendly is BN, BLS or NOT (if not pairing friendly
	...
	if x==2:
		...
		curve_selected=True
	if x==3:
		curveset("256","GM256","NIST256","32","24","256","7","NOT_SPECIAL","WEIERSTRASS","NOT")
		curve_selected=True
	if x==4:
		curveset("256","B256","BRAINPOOL","32","24","256","7","NOT_SPECIAL","WEIERSTRASS","NOT")
		curve_selected=True
	if x==5:
		curveset("256","A256","ANSSI","32","24","256","7","NOT_SPECIAL","WEIERSTRASS","NOT")
		curve_selected=True

	if x==6:
		curveset("336","336PM","HIFIVE","42","23","336","5","PSEUDO_MERSENNE","EDWARDS","NOT")
		curve_selected=True
	if x==7:
		curveset("448","448GM","GOLDILOCKS","56","23","448","7","GENERALISED_MERSENNE","EDWARDS","NOT")
		curve_selected=True
	if x==8:
		curveset("384","GM384","NIST384","48","","28","56","384","7","NOT_SPECIAL","WEIERSTRASS","NOT")
		curve_selected=True
	if x==9:
		curveset("416","414PM","C41417","52","23","414","7","PSEUDO_MERSENNE","EDWARDS","NOT")
		curve_selected=True
	if x==10:
		curveset("528","521M","NIST521","66","23","521","7","PSEUDO_MERSENNE","WEIERSTRASS","NOT")
		curve_selected=True
	...
	if x==23:
		curveset("256","254BN","BN254","32","24","254","3","NOT_SPECIAL","WEIERSTRASS","BN")
		pfcurve_selected=True
	if x==24:
		curveset("256","254BNCX","BN254CX","32","24","254","3","NOT_SPECIAL","WEIERSTRASS","BN")
		pfcurve_selected=True
	if x==25:
		curveset("384","383BLS","BLS383","48","23","383","3","NOT_SPECIAL","WEIERSTRASS","BLS")
		pfcurve_selected=True
