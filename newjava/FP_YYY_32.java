...
public final class FP_YYY {
	...
	public static final int FEXCESS =((int)1<<(BIG_XXX.BASEBITS*BIG_XXX.NLEN-MODBITS)); 
	public static final int OMASK=(int)(-1)<<(MODBITS%BIG_XXX.BASEBITS);
...
/* calculate Field Excess */
	public static int EXCESS(BIG_XXX a)
	{
...
/* reduce a DBIG to a BIG using the appropriate form of the modulus */
	public static BIG_XXX mod(DBIG_XXX d)
	{
		...
		{ // GoldiLocks Only
			...
			int carry=b.w[BIG_XXX.NLEN-1]>>TBITS;
			b.w[BIG_XXX.NLEN-1]&=TMASK;
			b.w[0]+=carry;
