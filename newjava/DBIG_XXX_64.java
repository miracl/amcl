...
public class DBIG_XXX {
	protected long[] w=new long[BIG_XXX.DNLEN];
...
/*
	public String toRawString()
	{
		...
		s+=Long.toHexString(b.w[BIG_XXX.DNLEN-1]); s+=")";
		return s;
	}
*/
...
/* split DBIG at position n, return higher half, keep lower half */
	public BIG_XXX split(int n)
	{
		...
		int m=n%BIG_XXX.BASEBITS;
		long nw,carry=w[BIG_XXX.DNLEN-1]<<(BIG_XXX.BASEBITS-m);
		...
		for (int i=BIG_XXX.DNLEN-2;i>=BIG_XXX.NLEN-1;i--)
		{
			...
			//t.set(i-BIG_XXX.NLEN+1,nw);
		}
		w[BIG_XXX.NLEN-1]&=(((long)1<<m)-1);
		return t;
	}
...
/* Copy from a BIG 
	public void copy(BIG_XXX x)
	{
		...
		w[BIG_XXX.NLEN-1]=x.w[BIG_XXX.NLEN-1]&BIG_XXX.BMASK; 
		w[BIG_XXX.NLEN]=x.w[BIG_XXX.NLEN-1]>>BIG_XXX.BASEBITS;
...
/* reduces this DBIG_XXX mod a DBIG_XXX in place */
