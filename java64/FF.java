...
/* shift right by ROM.BIGBITS-bit words */
...
/* shift left by ROM.BIGBITS-bit words */
...
/* nresidue mod m */
	...
	public void modsqr(FF p,FF nd)
	{
		...
		FF d=sqr(this);
//if ((ROM.debug)) System.out.println("d= "+d.toString());
		copy(d.reduce(p,nd));
	}
...
//int i=0;
		...
		else for (; ; )
		{
			...
			e>>=1;
			if (e==0) break;
//System.out.println("wb= "+w.toString());
//ROM.debug=true;
			w.modsqr(p,ND);
//ROM.debug=false;
//System.out.println("wa= "+w.toString());
//i+=1;
